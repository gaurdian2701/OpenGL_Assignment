#include "LoggedMesh.h"
#include "ShaderProgram.h"
#include "glad/glad.h"

LoggedMesh::LoggedMesh(VertexData vertexData,
...
std::vector<std::pair<std::string, float>>& LoggedMesh::GetLogData()
{
    return m_loggedData;
}

void LoggedMesh::Draw(ShaderProgram* shaderProgram, DrawMode drawMode)
{
...
void LoggedMesh::SetupOffsets(std::vector<glm::vec3>* offsets)
{
    m_offsets = *offsets;
}

void LoggedMesh::SetupInstanceCount(unsigned int instanceCount)
{
